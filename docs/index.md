...
<figure markdown="span">
  ![One result from six of the thirteen subpackages](assets/figures/overview-gallery.svg#only-light)
  ![One result from six of the thirteen subpackages](assets/figures/overview-gallery-dark.svg#only-dark)
  <figcaption>Six of the thirteen subpackages, each running the method it is named for. Every figure on this site is generated by <code>tools/gen_figures.py</code> from the library itself, so none of them can drift from the code they illustrate.</figcaption>
</figure>
...
Thirteen subpackages. Every one of them imports `core`; the arrows below are
the rest of the import graph, which is also the order in which the library is
worth reading.
